 ...
 * Used by Sidebar, Dashboard quick links, and Route Health Grid
 */
 ...
 * Order matters: items appear in this order in sidebar
 */
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    href: '/preview',
    icon: EyeIcon,
    description: 'Live app preview and route health',
  },
  {
    key: 'forge',
    label: 'Forge',
    href: '/forge',
    icon: FireIcon,
    description: 'Multi-agent spec execution',
  },
  {
    key: 'projects',
    label: 'Projects',
  ...
  },
  {
    ...
    href: '/copilot',
    icon: SparklesIcon,
    description: 'AI assistant with sources',
  },
  {
    key: 'drafts',
    label: 'Drafts',
    ...
    description: 'Copilot draft management',
  },
];
...
/**
 * Get nav items for route health checking (excludes dashboard)
 */
export function getRouteHealthItems(): NavItem[] {
