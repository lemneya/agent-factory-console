...
import { EmptyState } from "@/components/auth";
    ...
    <main data-testid="page-root">
      ...
      {blueprints.length === 0 ? (
        <EmptyState
          ...
          description="Blueprints define the structure of your project with modules, dependencies, and acceptance criteria."
          ctaText="Create Blueprint"
          ctaHref="/blueprints/new"
          secondaryText="Learn about blueprints"
          secondaryHref="/docs/blueprints"
        />
      ) : (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
