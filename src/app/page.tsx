      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {quickLinkItems.map(item => {
          ...
          return (
            ...
            >
              <div
                className={`mb-4 flex h-12 w-12 items-center justify-center rounded-lg ${colors.bg} ${colors.text} dark:bg-opacity-20`}
              >
                <Icon className="h-6 w-6" />
              </div>
              <h2
                className={`text-lg font-semibold text-gray-900 group-hover:${colors.text} dark:text-white`}
              >
                {item.label}
              </h2>
