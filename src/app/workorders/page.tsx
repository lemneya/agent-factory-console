    ...
    <main data-testid="page-root">
      ...
      {workOrders.length === 0 ? (
        <EmptyState
          ...
          description="WorkOrders are created by slicing a published Blueprint version. Create and publish a blueprint first."
          ctaText="Go to Blueprints"
          ctaHref="/blueprints"
          secondaryText="Learn about slicing"
          secondaryHref="/docs/workorders"
        />
      ) : (
