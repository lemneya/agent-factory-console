...
// Factory navigation items (AFC-1.7+)
const factoryNavigation = [
  { name: "Blueprints", href: "/blueprints", icon: BlueprintIcon },
  { name: "WorkOrders", href: "/workorders", icon: WorkOrderIcon },
  { name: "Assets", href: "/assets", icon: AssetIcon },
];

// Governance navigation items
const governanceNavigation = [
  { name: "Council", href: "/council", icon: CouncilIcon },
  ...
  return (
    <div className="flex h-full w-64 flex-col border-r border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
      ...
      <nav className="flex-1 space-y-6 overflow-y-auto px-3 py-4">
        ...
        <NavSection title="Factory" items={factoryNavigation} pathname={pathname} />
        <NavSection title="Governance" items={governanceNavigation} pathname={pathname} />
      </nav>
    </div>
  );
}
